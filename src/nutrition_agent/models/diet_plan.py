...
class Meal(BaseModel):
    ...
    Each meal includes ingredients, preparation steps, and caloric information.
    ...
    Example:
        ...
        ...     ingredients=["3 huevos (150g)", "Espinaca (100g)", "Queso (30g)"],
    ...
    ingredients: list[str] = Field(
        ...,
        min_length=1,
        description="Ingredients with quantities in grams or units",
        examples=[
            ["3 huevos enteros (150g)", "Espinaca (100g)", "Queso bajo en grasa (30g)"],
            ["Pechuga de pollo (200g)", "Brocoli (150g)", "Aceite de oliva (10ml)"],
        ],
    )
